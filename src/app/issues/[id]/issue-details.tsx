...
import { createComment } from "@/http/creat-comment"
...
import { IssueLoadingSkeleton } from "./issue-comments/issue-comments-skeleton"
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="mt-3">
          <Suspense fallback={<IssueLoadingSkeleton />}>
